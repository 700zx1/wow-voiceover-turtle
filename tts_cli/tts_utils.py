...
class TTSProcessor:
    def __init__(self, api_key, default_model, default_stab, default_sim):
        self.api_key       = api_key
        self.default_model = default_model
        self.default_stab  = default_stab
        self.default_sim   = default_sim

    def synthesize(self, text: str, voice_id: str, *,
                   model_id: str = None,
                   stability: float = None,
                   similarity_boost: float = None) -> bytes:
        # fallback to defaults if not passed
        model_id         = model_id or self.default_model
        stability        = stability or self.default_stab
        similarity_boost = similarity_boost or self.default_sim
